...
```{r}
active_properties_0010 <- readRDS('/capstone/pyforest/lup_assessment_data/active_inactive/active_inactive.rds') |> 
  left_join(limit_fecha_res, by= "put_id") |> 
  filter(anho_capa <= 2010 & year_inactive >= 2010)

#write_rds(active_properties_0010,'/capstone/pyforest/ml_data/active_inactive_subsets/active_properties_0010.rds')
```
...
active_inactive <- active_properties_0010
...
st_write(clean,'/capstone/pyforest/ml_data/active_inactive_subsets/active_inactive_0010.gpkg')
